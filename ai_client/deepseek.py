...
【重要：价格路径推演】在完成六步推演后，你必须用“先…然后…最后…”的结构推演价格路径。每段必须包含：①具体价格目标 ②触发条件 ③预计耗时。
示例格式：
- 先上冲至2410，触发条件：卖一墙被吃掉80%，预计5分钟内。
- 然后回踩2390，触发条件：CVD转负，预计15分钟盘整。
- 最后下跌至2295，触发条件：跌破2400整数关口，预计1小时内。
